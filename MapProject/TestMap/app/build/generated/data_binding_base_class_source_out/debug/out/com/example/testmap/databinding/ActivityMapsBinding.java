...
public final class ActivityMapsBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialToolbar appActionbar;
  ...
  private ActivityMapsBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialToolbar appActionbar, @NonNull BottomNavigationView bottomNavigation,
  ...
  public static ActivityMapsBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.app_actionbar;
      MaterialToolbar appActionbar = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityMapsBinding((ConstraintLayout) rootView, appActionbar, bottomNavigation,
          mainFrame);
    }
